...
class MagazinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create magazine" do
    assert_difference('Magazine.count') do
      post magazines_url, params: { magazine: { facebook: @magazine.facebook, mail: @magazine.mail, title: @magazine.title, website: @magazine.website } }
    end
  ...
  test "should update magazine" do
    patch magazine_url(@magazine), params: { magazine: { facebook: @magazine.facebook, mail: @magazine.mail, title: @magazine.title, website: @magazine.website } }
